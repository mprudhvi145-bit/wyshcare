 ...
 * ============================================================================
 *
 * File: apps/patient-mobile/lib/features/insurance/insurance_claim_detail_screen.dart
 *
 * Product:
 ...
 *
 * Purpose:
 * Flutter screen: insurance_claim_detail_screen
 *
 * Responsibilities:
...
class InsuranceClaimDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FeatureScreen(
      title: 'Claim Detail',
      showBack: true,
      child: Text('Claim $claimId — status, documents, and reimbursement timeline.'),
    );
  }
}
