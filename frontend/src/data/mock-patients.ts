...
export const MOCK_PATIENTS: MockPatient[] = [
  ...
  {
    id: 'pat-016',
    fullName: 'Dr. Ashok Srinivas',
    age: 47,
    gender: 'Male',
    bloodGroup: 'O+',
    mrn: 'WYSH-016',
    specialty: 'general-surgery',
    condition: 'Hernia (Ventral), Cholelithiasis, Lipoma (Back)',
    risk: 'low',
    lastVisit: '2026-06-10',
    appointmentTime: '09:00',
    status: 'scheduled',
    vitals: { bp: '124/78', hr: 72, temp: 98.4, spo2: 99 },
    allergies: ['Latex'],
    medications: ['Pantoprazole', 'Paracetamol'],
  },
  {
    id: 'pat-017',
    fullName: 'Meena Iyengar',
    age: 55,
    gender: 'Female',
    bloodGroup: 'A+',
    mrn: 'WYSH-017',
    specialty: 'radiology',
    condition: 'Lumbar Spine DJD, Liver Hemangioma (Incidental), Renal Cyst',
    risk: 'medium',
    lastVisit: '2026-06-09',
    appointmentTime: '11:30',
    status: 'checked_in',
    vitals: { bp: '138/84', hr: 76, temp: 98.6, spo2: 98 },
  ...
  },
  {
    ...
    condition: 'Pre-op Assessment for Total Knee Replacement, OSA Moderate',
    risk: 'high',
    lastVisit: '2026-06-11',
    appointmentTime: '14:00',
    status: 'waiting',
    vitals: { bp: '148/90', hr: 84, temp: 98.2, spo2: 94 },
    allergies: ['Morphine'],
    medications: ['Metoprolol', 'Losartan', 'Atorvastatin'],
  },
];
