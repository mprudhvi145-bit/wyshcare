 ...
 * ============================================================================
 *
 * File: backend/src/modules/care-plans/care-plans.module.ts
 *
 * Product:
 ...
 *
 * Purpose:
 * NestJS module: wires providers, controllers, and imports for care-plans
 *
 * Responsibilities:
 * - Configure dependency injection for care-plans
