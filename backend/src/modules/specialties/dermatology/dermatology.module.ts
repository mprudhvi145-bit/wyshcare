 ...
 * ============================================================================
 *
 * File: backend/src/modules/specialties/dermatology/dermatology.module.ts
 *
 * Product:
 ...
 *
 * Purpose:
 * NestJS module: wires providers, controllers, and imports for dermatology
 *
 * Responsibilities:
 * - Configure dependency injection for dermatology
