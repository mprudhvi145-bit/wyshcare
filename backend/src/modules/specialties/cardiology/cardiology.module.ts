 ...
 * ============================================================================
 *
 * File: backend/src/modules/specialties/cardiology/cardiology.module.ts
 *
 * Product:
 ...
 *
 * Purpose:
 * NestJS module: wires providers, controllers, and imports for cardiology
 *
 * Responsibilities:
 * - Configure dependency injection for cardiology
