 ...
 * ============================================================================
 *
 * File: backend/src/modules/health-graph/health-graph.module.ts
 *
 * Product:
 ...
 *
 * Purpose:
 * NestJS module: wires providers, controllers, and imports for health-graph
 *
 * Responsibilities:
 * - Configure dependency injection for health-graph
