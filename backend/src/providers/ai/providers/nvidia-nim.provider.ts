 ...
 * ============================================================================
 *
 * File: backend/src/providers/ai/providers/nvidia-nim.provider.ts
 *
 * Product:
 ...
 *
 * Purpose:
 * AI model provider: implements AIProvider interface for nvidia-nim
 *
 * Responsibilities:
 * - Implement AIProvider interface for nvidia-nim
